...
Der Katalog beschreibt den Bedarf des Vertical Slice. Er autorisiert weder Downloads noch Meshy-Generierungen. Bis zur manuellen Gate-0-Freigabe werden keine Assets importiert, erzeugt oder verändert. Vor jedem späteren Import gelten `ASSET_PIPELINE.md`, Lizenznachweis, Quellenprotokoll und isolierte Prüfung.
...
Jeder Eintrag wird erst nach Gate 0 per Such-/Dry-Run-Pipeline bewertet. „Quelle“ bezeichnet die bevorzugte Bibliothek, nicht eine bereits ausgewählte Datei.
